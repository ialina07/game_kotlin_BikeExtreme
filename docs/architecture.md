...
| **PlayerState** | position, energy, condition, water | Рысурсы игрока в данный момент |

### 3. Бизнес-логика

**GameRules** — применяет правила игры к состоянию игрока:
- applyWeather() — жара, дождь, ветер, шторм
- applyMovement() — движение по выпавшему числу
- applyEnergyCost() — расход энергии за ход
- applyEvent() — случайные события (родник, прокол, спринт)
- applyRest() — отдых (восстановление ресурсов)
